<template>
  <div>
    ...
    <el-card>
      <el-row>
        <el-col>
          <el-button type="primary" class="btn" @click="showAddCateDialogVisible">添加分类</el-button>
        </el-col>
      </el-row>
      <!-- 表格区域 -->
    ...
    <el-dialog title="添加分类" :visible.sync="addCateDialogVisible" width="50%" @close="addCateDialogClosed" >
      <el-form ref="addCateFormRef" :model="addCateForm" label-width="100px" :rules="addCateFormRules" >
        ...
        <el-form-item label="父级分类" >
          <el-cascader expandTrigger= 'hover' v-model="selectedKeys" :options="parentCateList"   :props="parentCateProps"
...
export default {
  ...
  methods:{
    ...
    parentCateChanged(){
      ...
      //如果selectedKeys的length大于0，说明选中了父级分类，反之，则没有选中
